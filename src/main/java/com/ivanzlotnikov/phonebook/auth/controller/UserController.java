...
import com.ivanzlotnikov.phonebook.auth.mapper.UserMapper;
...
/**
 * Контроллер для управления пользователями системы. Предоставляет интерфейс для CRUD операций с
 * пользователями. Доступен только для администраторов.
 */
@Slf4j
@Controller
